  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var m = function() {
      ...
      return r(t2, [{
        ...
        key: "drawXMarker",
        value: function(t3, e2, i2, a2, s2) {
          var r2 = a2 / 2, o2 = "cross" === i2 ? "M ".concat(t3 - r2, " ").concat(e2 - r2, " L ").concat(t3 + r2, " ").concat(e2 + r2, "  M ").concat(t3 - r2, " ").concat(e2 + r2, " L ").concat(t3 + r2, " ").concat(e2 - r2) : "M ".concat(t3 - r2, " ").concat(e2, " L ").concat(t3 + r2, " ").concat(e2, "  M ").concat(t3, " ").concat(e2 - r2, " L ").concat(t3, " ").concat(e2 + r2), n2 = this.drawPath({
            d: o2,
        ...
        value: function(t3, i2, a2) {
          ...
          if ("cross" === (null == a2 ? void 0 : a2.shape)) r2 = this.drawXMarker(t3, i2, null == a2 ? void 0 : a2.shape, 1.8 * s2, e(e({}, a2), {}, {
            pointStrokeColor: a2.pointFillColor
          }));
          else if ("plus" === (null == a2 ? void 0 : a2.shape)) r2 = this.drawXMarker(t3, i2, null == a2 ? void 0 : a2.shape, 2 * s2, e(e({}, a2), {}, {
            pointStrokeColor: a2.pointFillColor
          }));
          else if ("line" === (null == a2 ? void 0 : a2.shape)) (r2 = this.drawLine(t3 - s2, i2, t3 + s2, i2, a2.pointFillColor, a2.pointStrokeDashArray, a2.pointStrokeWidth, a2.pointStrokeLineCap)).attr({
            cx: t3,
            cy: i2,
            ...
            l2.attr({
              ...
              cy: i2,
              class: a2.class ? a2.class : "",
              fill: a2.pointFillColor,
              "fill-opacity": a2.pointFillOpacity ? a2.pointFillOpacity : 1,
              stroke: a2.pointStrokeColor,
              "stroke-width": a2.pointStrokeWidth ? a2.pointStrokeWidth : 0,
              "stroke-opacity": a2.pointStrokeOpacity ? a2.pointStrokeOpacity : 1
            }), r2 = l2;
          } else "circle" !== a2.shape && a2.shape || (x.isNumber(i2) || (s2 = 0, i2 = 0), r2 = this.drawCircle(s2, {
            cx: t3,
            cy: i2,
            class: a2.class ? a2.class : "",
            stroke: a2.pointStrokeColor,
        ...
        value: function(t3) {
          ...
          if (Array.isArray(o2) && (p2 = o2[i2]), "circle" !== p2) {
            var f2 = new D(this.ctx).getMarkerConfig({
              ...
              seriesIndex: i2,
              size: n2,
              pRadius: Array.isArray(g2) ? g2[i2] : g2,
              strokeWidth: "plus" === p2 || "cross" === p2 || "line" === p2 ? Array.isArray(c2) ? c2[i2] : c2 : 0
            }), x2 = SVG(r2).size("100%", "100%"), b2 = new m(this.ctx).drawMarker(0, 0, e(e({}, f2), {}, {
              pointFillColor: Array.isArray(s2.config.legend.markers.fillColors) ? a2[i2] : f2.pointFillColor,
              shape: p2
            }));
